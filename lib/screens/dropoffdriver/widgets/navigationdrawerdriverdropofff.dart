    ...
    switch (index) {
      case 0:
        Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => DropoffDriverDashboard(
              id: id,
      ...
      case 2:
        Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => DropoffPastDeliveries(
              id: id,
              driveroccupied: driveroccupied,
              operationalcenterid: operationalcenterid),
        ));
      ...
      case 3:
        Navigator.of(context).push(MaterialPageRoute(
          builder: (context) => DropoffDriverProfile(
              id: id,
              driveroccupied: driveroccupied,
              operationalcenterid: operationalcenterid),
        ));
