...
class CustomerPastPackageDetail extends StatefulWidget {
  String packageId;
  //const CustomerPastPackageDetail({Key? key}) : super(key: key);
  CustomerPastPackageDetail(this.packageId);

  @override
  State<CustomerPastPackageDetail> createState() =>
      _CustomerPastPackageDetailState();
}

class _CustomerPastPackageDetailState extends State<CustomerPastPackageDetail> {
